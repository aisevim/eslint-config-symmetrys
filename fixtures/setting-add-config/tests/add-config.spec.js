...
describe('Add new configs to the end of config array (higher priority), see `./setting-add-config/eslint.config.js` for customisation details', () => {
  it('Should add 2 configs, and generate 1 error by configs', ({ expect }) => {
    let output
