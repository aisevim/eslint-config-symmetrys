...
describe.concurrent('Without any configurations, enabled automaticly configs, see `./auto-detect-packages/eslint.config.js` for customisation details', () => {
  it.concurrent('Should auto detect files', ({ expect }) => {
    let output
