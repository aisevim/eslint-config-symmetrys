...
describe('Without any configurations, enabled automaticly configs, see `./auto-detect-packages/eslint.config.js` for customisation details', () => {
  it('Should auto detect files', ({ expect }) => {
    let output
